...
if __name__ == '__main__':
    ...
    time_and_location_parameters = user.get_time_location(day = datetime(2027, 6, 21, 0, 0), lat = 33, h = 23000)
    ...
    # utils.mission_planning(payload_mass, mass_properties, user_defined_parameters)
