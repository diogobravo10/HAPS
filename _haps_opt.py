...
result = brute(utils.obj_fun, ranges, args= (azores_flight_envelope, user_defined_parameters, solar_cell_efficiency), finish=None) # I need more constraints

print(f"Optimal M_Sw: {result[0]:.2f} kg, Optimal Mbat_Sw: {result[1]:.2f} kg: Points Validated: {-utils.obj_fun(result, azores_flight_envelope, user_defined_parameters, solar_cell_efficiency=0.15)}")
